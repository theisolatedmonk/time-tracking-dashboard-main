...
export default function Home () {
  ...
  return (
    <div className='flex flex-col min-h-screen w-full bg-veryDarkBlue  justify-center items-center '>
      <div className='flex gap-- p-10 sm:p-12 w-full flex-col sm:flex-row  justify-center items-center font-Rubik gap-6  sm:max-h-[600px] sm:w-[1100px]'>
        <div className='rounded-lg bg-darkBlue hover:bg-  w-full sm:w-[25%] h-full   '>
